...
public enum Action {
    EXECUTE(TransactionContext.Result.COMMITTED),
    SIMULATE(TransactionContext.Result.ABORTED);

    private final TransactionContext.Result fluidAction;

    Action(TransactionContext.Result fluidAction) {

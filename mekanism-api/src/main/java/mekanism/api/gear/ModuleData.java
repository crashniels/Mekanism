...
public class ModuleData<MODULE extends ICustomModule<MODULE>>  implements IHasTranslationKey, IModuleDataProvider<MODULE> {
    ...
    public String getTranslationKey() {
        if (translationKey == null) {
            translationKey = Util.createTranslationKey("module", new Identifier(getRegistryName().toString()));
        }
    ...
    public String getDescriptionTranslationKey() {
        if (descriptionTranslationKey == null) {
            descriptionTranslationKey = Util.createTranslationKey("description", new Identifier(getRegistryName().toString()));
        }
    ...
    public static class ModuleDataBuilder<MODULE extends ICustomModule<MODULE>> {
         ...
         */
        public static <MODULE extends ICustomModule<MODULE>> ModuleDataBuilder<MODULE> custom(@NotNull NonNullSupplier<MODULE> customModule,
        ...
        private ModuleDataBuilder(@NotNull NonNullSupplier<MODULE> supplier, @NotNull IItemProvider itemProvider) {

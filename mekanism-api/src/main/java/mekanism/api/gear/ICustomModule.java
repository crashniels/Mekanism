...
public interface ICustomModule<MODULE extends ICustomModule<MODULE>> {
     ...
     * IModule#displayModeChange(PlayerEntity, net.minecraft.text.Text, IHasTextComponent)} is provided to help display the mode change when {@code displayChangeMessage} is {@code
     * true}.
     *
     * @param module               Module instance.
    ...
    /**
     * Represents the different result states of {@link ICustomModule#onDispense(IModule, net.minecraft.util.math.BlockPointer)}.
     */
